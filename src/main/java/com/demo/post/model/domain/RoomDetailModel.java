...
public class RoomDetailModel {
    ...
    public RoomDetailModel(RoomsEntity roomsEntity) {
        this.id = roomsEntity.getId();
        this.name = roomsEntity.getName();
        this.description = roomsEntity.getDescription();
        this.person = roomsEntity.getPerson();
        this.price = roomsEntity.getPrice();
        this.type = roomsEntity.getType();
